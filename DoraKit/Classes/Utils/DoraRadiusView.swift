...
public class DoraRadiusView: UIView {
    ...
    @IBInspectable var dora_CornerRadius: CGFloat = 0
    ...
    public  func maskview() {
        ...
        if topLeftRadius || topRightRadius || bottomLeftRadius || bottomRightRadius {
            ...
            let cornerRadii = CGSize(width: dora_CornerRadius, height: dora_CornerRadius)
