...
///自定义彩色圆形进度条
public class LSFCircleProgressView : UIView {
...
//        self.layer.addSublayer(trackLayer!)
    ...
    private func drawLayer(strokeColor:UIColor) -> CAShapeLayer {
        ...
        // 1.画背景圆
        let center = CGPoint.init(x: self.lsf_width / 2.0, y: self.lsf_height / 2.0)
        let radius = (self.lsf_width - lineWidth) / 2.0
