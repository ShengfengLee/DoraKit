...
public extension Date {
    static func lsf_timestamp(_ timestamp:String?) -> Date? {
        let timeInterval = Double.lsf_parse(timestamp)
        
        return Date.init(timeIntervalSince1970: timeInterval)
    }
    
    ///根据日期字符串返回日期
    static func lsf_date(_ timeStr: String, formate:String) -> Date? {
...
//        formatter.locale = Locale(identifier: "zh_CN")
    ...
    ///根据日期返回日期字符串
    static func lsf_formateStr(_ date:Date, formate:String) -> String {
        let formatter = DateFormatter.init()
        formatter.dateFormat = formate
//        formatter.locale = Locale(identifier: "zh_CN")
    ...
    func lsf_formate(_ formate: String) -> String {
        return Date.lsf_formateStr(self, formate: formate)
    }
    
    ///根据时间戳返回日期字符串
    static func lsf_formateStr(timeInterval:TimeInterval, formate:String) -> String {
...
//        formatter.locale = Locale(identifier: "zh_CN")
    ...
    ///年龄
    static func lsf_age(_ timeInterval:TimeInterval) -> Int {
    ...
    static func lsf_duration(timeInterval: Int) -> String {
        //秒
    ...
    ///时分秒
    static func lsf_hourDuration(timeInterval: Int) -> String {
        //秒
        let second = timeInterval % 60
        //分钟
        let minute = timeInterval / 60
