...
public extension UIImage {
    ...
    ///通过UIColor 生成图片
    static func dora_image(color:UIColor, size:CGSize = CGSize.init(width: 1, height: 1)) -> UIImage? {
    ...
    ///圆角图片
    func dora_radiusImage(_ cornerRadius: CGFloat? = nil) -> UIImage? {
    ...
    //*
    func dora_fixOrientation() -> UIImage {
    ...
    ///正方形圆角图片
    func dora_squalAndRadius(_ cornerRadius: CGFloat? = nil) -> UIImage? {
        //新的image宽度
        let squalWidth = min(size.width, size.height)
